...
//!
//! Note: The `Lifetime` decoration type exists but is filtered out from diagnostics
//! as "too verbose". References produce `imm-borrow` or `mut-borrow` decorations instead.
...
fn lifetime_basic_reference() {
    ...
    TestCase::new("lifetime_basic_reference", r#"
        fn test() {
...
fn lifetime_function_param() {
    ...
    TestCase::new("lifetime_function_param", r#"
...
fn lifetime_struct_field() {
    // Struct construction with reference field - no special decoration on the struct itself
    // The borrow is implicit in the field assignment
    TestCase::new("lifetime_struct_field", r#"
        struct Wrapper<'a> {
            data: &'a str,
        }
...
fn lifetime_return_reference() {
    ...
    TestCase::new("lifetime_return_reference", r#"
...
fn lifetime_mut_reference() {
    ...
    TestCase::new("lifetime_mut_reference", r#"
        fn test() {
...
fn lifetime_static() {
    ...
    TestCase::new("lifetime_static", r#"
...
fn lifetime_nested_struct() {
    ...
    TestCase::new("lifetime_nested_struct", r#"
        struct Inner<'a> {
            data: &'a str,
        }
